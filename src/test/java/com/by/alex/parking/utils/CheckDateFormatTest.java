...
public class CheckDateFormatTest {
	...
	public void checkDateFormatValidationPositive(){
		Assert.assertTrue(CheckDateFormat.validate(validTestData), "Check that time '" + validTestData + "' is correct");
		
	}

	@Test(description = "checkDateFormatValidationNegative")
	public void checkDateFormatValidationNegative(){
		Assert.assertFalse(CheckDateFormat.validate(invalidTestData), "Check that time '" + invalidTestData + "' is incorrect");
